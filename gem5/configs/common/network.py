...
class QNetwork(nn.Module):
    ...
    def __init__(self, state_space: int, action_num: int, action_scale: int):
        ...
        self.actions = [nn.Sequential(nn.Linear(256, action_scale),
               nn.ReLU()
              ) for _ in range(action_num)]
    ...
    # def __init__(self, state_space: int, action_num: int, action_scale: int):
        ...
        # self.actions = [nn.Sequential(nn.Linear(state_space*1,state_space*5),
              # nn.ReLU(),
        ...
        # self.value = nn.Sequential(nn.Linear(state_space*1,state_space*5),
              # nn.ReLU(),
